...
public class Problem2 {
    ...
    private static int _solve(String[] input) {
        ...
        for (var str : input) {
            ...
            System.out.println( str + " " /*+ List.of(numbers) + " " */+  firstNumber + lastNumber/* + " "*/ );
    ...
    private static String[] getNumbersFromWords (String str) {
        ...
        for (int i = 0; i < str.length ( ); i++) {
            ...
            if (AocUtility.tryParse ( ch )) {
                ...
                var potentialNumber = AocUtility.parseNumberFromWord ( str, i );
                var number = potentialNumber[1];
                if (!number.isBlank ()) {
                    numbers.add(number);
//                    i += potentialNumber[0].length();
                }
            }
        }
